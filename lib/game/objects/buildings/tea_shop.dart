  ...
  Future<void> onLoad() async {
    ...
    animation = SpriteAnimation.fromFrameData(
        ...
        SpriteAnimationData([
          ...
          spriteSheet.createFrameData(0, 8, stepTime: stepTime),
          ...
          spriteSheet.createFrameData(1, 8, stepTime: stepTime),
          ...
          spriteSheet.createFrameData(2, 8, stepTime: stepTime),
          ...
          spriteSheet.createFrameData(3, 8, stepTime: stepTime),
          ...
          spriteSheet.createFrameData(4, 8, stepTime: stepTime),
          ...
          spriteSheet.createFrameData(5, 8, stepTime: stepTime),
          ...
          spriteSheet.createFrameData(6, 8, stepTime: stepTime),
          ...
          spriteSheet.createFrameData(7, 8, stepTime: stepTime),
        ]));
