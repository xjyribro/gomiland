...
class ShopSideJap extends SpriteComponent with CollisionCallbacks {
  ShopSideJap({
  ...
  Future<void> onLoad() async {
    final image = await Flame.images.load(Assets.assets_images_buildings_shop_side_jap_png);
    final spriteSheet = SpriteSheet(
      image: image,
      srcSize: Vector2(160,256),
    );
