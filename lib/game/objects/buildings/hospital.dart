...
class Hospital extends SpriteComponent with CollisionCallbacks {
  Hospital({
  ...
  Future<void> onLoad() async {
    sprite = await Sprite.load(Assets.assets_images_buildings_hostpital_png);
    RectangleHitbox hitbox = RectangleHitbox(
        size: Vector2(512, 224),
