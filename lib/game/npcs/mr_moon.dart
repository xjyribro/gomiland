...
class MrMoon extends Npc with HasGameReference<GomilandGame> {
  MrMoon({required super.position});
  ...
  @override
  void onLoad() async {
    final image = await Flame.images.load(Assets.assets_images_npcs_moon_png);
  ...
  Future<void> startConversation(Vector2 playerPosition) async {
    ...
    int progressLevel =
    getCharacterProgress(RubbishType.food, game.progressStateBloc.state);
    ...
    yarnProject
      ...
      ..parse(await rootBundle.loadString(Assets.assets_yarn_moon_yarn));
